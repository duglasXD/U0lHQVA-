                            ...
                            <div class="navbar-header">
                                <a class="navbar-brand" href="index.html">
                                    ...
                                    <b>
                                        ...
                                        <!-- Dark Logo icon -->
                                        <img src="<?php echo base_url(); ?>images/logo.png" width="90" height="60" alt="homepage" class="dark-logo" />
                                    ...
                                    <span>
                                        <!-- dark Logo text -->
                                        <img src="<?php echo base_url(); ?>images/logo.png" width="135" height="60" alt="homepage" class="dark-logo" />
                                        <!-- Light Logo icon -->
                                        <img src="<?php echo base_url(); ?>images/logo.png" width="135" height="60" alt="homepage" class="light-logo" /></span> </a>
                            </div>
                            <!-- ============================================================== -->
                            <!-- End Logo -->
                            <!-- ============================================================== -->
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right scale-up">
                                            <ul class="dropdown-user">
                                                ...
                                                <li role="separator" class="divider"></li>
                                                <li><a  href="javascript:formSubmit()"><i class="fa fa-power-off"></i> Cerrar Sesión</a></li>
